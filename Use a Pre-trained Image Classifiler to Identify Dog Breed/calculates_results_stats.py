...
#          (results_stats_dict) that's created and returned by this function.
...
#            -The results dictionary as results_dict within calculates_results_stats
#             function and results for the function call within main.
#         This function creates and returns the Results Statistics Dictionary -
#          results_stats_dict. This dictionary contains the results statistics
...
#       in the return statement with the results_stats_dict dictionary that you create
#       with this function
#
def calculates_results_stats(results_dict):
    ...
    dictionary (results_stats_dict) so that it's returned for printing as to help
    ...
    # this function
    # Creates empty dictionary for results_stats_dict
    results_stats_dict = dict()

    # Sets all counters to initial values of zero so that they can
    # be incremented while processing through the images in results_dict
    ...
    for key in results_dict:
        ...
        #          'n_correct_notdogs' is a key in the results_stats_dict dictionary
    ...
    results_stats_dict['n_images'] = len(results_dict)
    ...
    results_stats_dict['pct_match'] = results_stats_dict['n_match'] / results_stats_dict['n_images'] * 100
    ...
    if results_stats_dict['n_notdogs_img'] > 0:
        results_stats_dict['pct_correct_notdogs'] = (results_stats_dict['n_correct_notdogs'] /
                                                results_stats_dict['n_notdogs_img'])*100.0
    else:
        results_stats_dict['pct_correct_notdogs'] = 0.0

    # TODO 5f. REPLACE None with the results_stats_dict dictionary that you
