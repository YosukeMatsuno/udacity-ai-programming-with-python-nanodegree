...
def print_results(results_dict, results_stats_dict, model,
    ...
    print("{:20}: {:3d}".format('N Dog Images', results_stats_dict['n_dogs_img']))
    ...
    #          results_stats_dict
    #
    print("N Not-Dog Images: {}".format(results_stats_dict["n_correct_notdogs"]))

    # Prints summary statistics (percentages) on Model Run
    print(" ")
    for key in results_stats_dict:
        # TODO: 6b. REPLACE pass with CODE that prints out all the percentages
        #           in the results_stats_dict dictionary. Recall that all
        #           percentages in results_stats_dict have 'keys' that start with
    ...
    if (print_incorrect_dogs and
        ( (results_stats_dict['n_correct_dogs'] + results_stats_dict['n_correct_notdogs'])
        ...
        for key in results_dict:
            ...
            #           and the classifier label from results_dict dictionary
            ...
            #          format of the results_dict dictionary. Remember the value
            #          is accessed by results_dict[key] and the value is a list
            #          so results_dict[key][idx] - where idx represents the
            #          index value of the list and can have values 0-4.
            #
            # Pet Image Label is a Dog - Classified as NOT-A-DOG -OR-
            # Pet Image Label is NOT-a-Dog - Classified as a-DOG
            for key in results_dict:
                if results_dict[key][3] == 1 and results_dict[key][4] == 0 or results_dict[key][3] == 0 and results_dict[key][4] == 1:
                    print("Real: {:>26} Classifier: {:>30}".format(results_dict[key][0], results_dict[key][1]))

    # IF print_incorrect_breed == True AND there were dogs whose breeds were incorrectly classified - print out these cases
    if (print_incorrect_breed and
        (results_stats_dict['n_correct_dogs'] != results_stats_dict['n_correct_breed'])
       ):
