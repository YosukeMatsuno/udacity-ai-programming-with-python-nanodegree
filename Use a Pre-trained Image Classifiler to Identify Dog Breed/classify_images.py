...
def classify_images(images_dir, results_dict, model):
    ...
    """
    # Process all files in the results_dict - use images_dir to give fullpath
    ...
    for key in results_dict:
       ...
       # as classifier label
       img_path = "{}/{}{}".format(os.path.dirname(__file__), images_dir, key)
       ...
       #           label and the classifier label) to the results_dict dictionary
       ...
       # results_dict as an exact match(1) using extend list function
       if truth in model_label:
           results_dict[key].extend([model_label])
           results_dict[key].extend([1])
       ...
       #           image label and the classifier label) to the results_dict
