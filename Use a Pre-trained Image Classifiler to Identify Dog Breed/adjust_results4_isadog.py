...
def adjust_results4_isadog(results_dict, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            #          exists within dognames_dict, then if the dogname(line)
            #          doesn't exist within dognames_dict then add the dogname(line)
            #          to dognames_dict as the 'key' with the 'value' of 1.
            #
    ...
    for key in results_dict:
        ...
        if results_dict[key][0] in dognames_dict:
            ...
            # Classifier Label IS image of Dog (e.g. found in dognames_dict)
            ...
            #           results_dict dictionary for the key indicated by the
            ...
            #
            # Classifier Label IS NOT image of dog (e.g. NOT in dognames_dict)
